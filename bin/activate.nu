...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/michaelkrause/Documents/Environments/simple_clustering_class'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/michaelkrause/Documents/Environments/simple_clustering_class/bin/deactivate.nu'
